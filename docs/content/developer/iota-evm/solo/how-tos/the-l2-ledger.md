...
[`deposit`](../../references/core-contracts/accounts.md#deposit) request to the
[`accounts` core contract](../../references/core-contracts/accounts.md) on the chain.

Finally, it sends a [`withdraw`](../../references/core-contracts/accounts.md#withdraw) request to the `accounts` core
