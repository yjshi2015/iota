...
## Concepts
`RevocationTimeframe2024` should be used together with selectively disclosable credentials - either [SD-JWT](../../iota-identity/how-tos/verifiable-credentials/selective-disclosure.mdx)
or [ZK-SD](../../iota-identity/how-tos/verifiable-credentials/zero-knowledge-selective-disclosure.mdx) - in order to conceal to the verifier
