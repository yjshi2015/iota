...
```rust reference
https://github.com/iotaledger/identity.rs/blob/v1.6.0-beta/examples/1_advanced/7_sd_jwt.rs
```
...
```ts reference
https://github.com/iotaledger/identity.rs/blob/v1.6.0-beta/bindings/wasm/identity_wasm/examples/src/1_advanced/6_sd_jwt.ts
```
