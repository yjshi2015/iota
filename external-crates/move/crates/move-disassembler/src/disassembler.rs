...
pub struct DisassemblerOptions {
    ...
    /// Maximum size of the output. If the output exceeds this size, the
    /// disassembler will return an error.
...
impl Disassembler<'_> {
    fn print_module(
        ...
        // NB: The order in which these are called is important as each function is
        // effectful.
